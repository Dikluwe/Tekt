...
Antes de você (Engenheiro) usar o seu tempo para aprovar, force a IA a duvidar do próprio trabalho com o **Prompt de Auto-Revisão**:
...
> Se encontrar QUALQUER omissão, reescreva/atualize o arquivo Markdown e os Contratos L0 agora cobrindo essa falha. Se você tiver certeza absoluta que o L0 mapeia toda a intenção do código legado sem perdas, responda apenas: 'Spec Auditada e Completa'."

Após a IA confirmar a correção autônoma, **o Engenheiro (Você) deve ler o Markdown final gerado em `00_nucleo/specs/`.**
Leia o objetivo, veja se as lógicas listadas cobrem o essencial do que o antigo código fazia.

Se ainda assim você encontrar defeitos, jogue a sua cartada final com o **Prompt de Correção Humana**:
...
Somente quando a Spec for o espelho da "Alma" do arquivo antigo, avance para a Clivagem.
