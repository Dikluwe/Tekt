...
> - **EVITAR VAZAMENTO DE CONTEXTO (L6):** Para máxima confiabilidade, designe dois agentes autônomos e isolados para a materialização: o Agente Implementador (gera apenas o código L1-L3 a partir da Spec L₀) e o Agente Testador (gera apenas os testes a partir da Spec L₀, sem enxergar o código do outro). A validação final ocorre sob isolamento de caixa-preta quando os dois outputs se integram e funcionam perfeitamente juntos.
> 
